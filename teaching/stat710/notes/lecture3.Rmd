...
It tells R to interpret whatever comes after literally instead of as a
special character.

For example, if you need quotes inside your string, you need to escape
...
What happens if the replacement string isn't the same length as the
piece of the string you want to replace?
...
- By default, when R reads in string data it will store it as a
factor.
...
- Factors are an integer vector plus a set of
names corresponding to each of the levels.
...
- Please see me if you have any questions about how to submit the
assignment or R scripts.
