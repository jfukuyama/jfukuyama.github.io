...
- Examples are all taken from "Bayesian Cognitive Modeling: A Practical Course" by Lee and Wagenmakers, and the implementations in stan are taken from the `rstan` [package](https://github.com/stan-dev/example-models/tree/master/Bayesian_Cognitive_Modeling)
