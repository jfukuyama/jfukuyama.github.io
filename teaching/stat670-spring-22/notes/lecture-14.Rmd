...
- (In some cases) the similarities between the variables,

- (In most cases) the similarities between the observations.
...
## A standard scatterplot can also be interpreted as a biplot

Suppose we have a matrix $\mathbf X$ with $n$ rows and 2 columns.

We can write
$$
\mathbf X = \mathbf X \begin{pmatrix} 1 & 0 \\ 0 & 1 \end{pmatrix}
$$
