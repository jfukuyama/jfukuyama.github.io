...
- If $\|\mathbf x\| = 1$ and $\|\mathbf y\| = 1$ (referred to as _unit vectors_), then $\mathbf x \cdot \mathbf y \in [-1, 1]$.
...
## The biplot shows us similarities between variables and similarities between samples

The biplot shows us similarities between the variables.

- If two biplot axes lie in the same orientation, the observations have approximately the same relative positions on both. This translates to the variables being similar to each other.
