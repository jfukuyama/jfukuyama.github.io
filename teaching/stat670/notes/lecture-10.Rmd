...
```{r}
ggplot(diamonds, aes(x = carat, y = log10(price))) + geom_point(size = .1, alpha = .2) + facet_wrap(~ clarity)
```
...
```{r}
ggplot(diamonds, aes(x = carat, y = sqrt(price), color = clarity)) + geom_point(size = .1, alpha = .2)
```
