...
The idea is that we want to find a an embedding of the points into a lower-dimensional space _and_ a monotonic transformation of the embedded distances  so that the transformed distances recapitulate the input distances as well as possible.
