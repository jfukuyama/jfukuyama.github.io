...
## Does chart position change by rank?
...
Let's try some of the power transformations on the fusion time data --- we would like to see which gives a distribution closest to normal.
